...
- ※ "game event"はユーザーが指定したイベント処理によって発生する遷移。Scene_MapだけでなくScene_Battleなどでもイベントが発生しうるので「戦闘中にショップ画面に移動する」ことも可能？
...
#### いつ拡張する？
- 全てのSceneで毎フレームごとの処理を変更したいとき
- 全てのScene切替時のフェードイン・フェードアウト処理を変更したいとき
- ゲームオーバー判定を変更したいとき
...
#### いつ拡張する？
- ゲーム初期化時に追加の処理させたいとき
- 画像・データベース・フォント・音声データ以外のデータを先読みさせたいとき
- デバッグオプションから飛ぶことができるSceneを増やしたいとき

#### Scene_Title
タイトル画面。
![Scene_Title](./images/Scene_Title.png)
#### いつ拡張する？
- タイトル画面に独自の情報を表示したいとき
- タイトル画面のメニューを増やしたいとき
...
#### いつ拡張する？
- 戦闘画面とメニュー画面以外にマップ画面から遷移する画面を増やしたいとき
- 戦闘画面に遷移するときの処理（画面点滅エフェクト・BGMを停止する処理）を変更したいとき
- メニュー画面に遷移するときのエフェクトを変更したいとき
...
##### いつ拡張する？
- メニューに表示される項目を変更したいとき
- 所持金ウィンドウを非表示にしたいとき
- ステータスウィンドウを非表示にしたいとき
...
##### いつ拡張する？
- ショップでの購入・売却処理を変更したいとき（質問に答えるとおまけで安くする機能とか？）
...
##### いつ拡張する？
- ゲームオーバー時に表示する情報を変更したいとき（死因の表示など）
